...
type PaymailAddress struct {
	...
	InternalXPubKey string           `json:"internal_xpub_key" toml:"internal_xpub_key" yaml:"internal_xpub_key" gorm:"<-:create;type:varchar(111);index;comment:This is a full xPub for identity usage" bson:"internal_xpub_key"` // PublicKey hex encoded
